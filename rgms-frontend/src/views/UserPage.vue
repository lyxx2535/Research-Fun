  ...
  <div>
    ...
    >
      ...
      <el-form-item class="update-user-info-footer">
        ...
        <el-button round @click="cancelEdit1">重 置</el-button>
      </el-form-item>
      <el-form-item label="当前密码" prop="password">
        <el-input style="width: 100%" v-model="oldPwd" show-password></el-input>
      </el-form-item>
      <el-form-item label="新密码" prop="password">
        <el-input style="width: 100%" v-model="newPwd" show-password></el-input>
      </el-form-item>
      <el-form-item class="update-user-info-footer">
        <el-button round type="primary" @click="updatePwd">确认修改</el-button>
        <el-button round @click="cancelEdit2">重 置</el-button>
      </el-form-item>
    </el-form>
    <el-button @click="bindQRCode">绑定微信</el-button>
  </div>
</template>
...
export default {
  ...
  methods: {
      bindQRCode(){
        var that=this;
        this.$axios.post('/wx/bound?uid='+window.sessionStorage.getItem("userId")).then(function(res){
          console.log(res)
    ...
    updateUser() {
      ...
      if (this.imgFile === null) {
        ...
        this.$axios
          .put("/user/userTrueNameAndEmailAndPortrait", updateForm)
          .then((res) => {
    ...
    updatePwd() {
      let updateForm = {};
      updateForm.userId = this.id;
      updateForm.oldPwd = this.oldPwd;
      updateForm.newPwd = this.newPwd;
      this.$axios
        .post("/user/updatePwd", updateForm)
        .then((res) => {
          //history.go(0); //刷新页面
          this.$message.success({
            message: "更新成功！",
